...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    public void start() {
        ...
        mOctaviSettingsObserver.observe();
        mOctaviSettingsObserver.update();
    ...
    private OctaviSettingsObserver mOctaviSettingsObserver = new OctaviSettingsObserver(mHandler);
    private class OctaviSettingsObserver extends ContentObserver {
        OctaviSettingsObserver(Handler handler) {
            super(handler);
        }
         void observe() {
